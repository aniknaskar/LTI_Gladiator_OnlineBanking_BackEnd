...
public class ForgotInternetBankingIdMail {
	...
	private static Message prepareMessage(Session session, String myEmail, String recipient, String m)
	{
		...
		Message message =new MimeMessage(session);
			...
			try {
				...
				message.setSubject("OTP for retrieving Internet Banking Id");
				message.setText(m);
				return message;
			} 
			catch (Exception e) {
				
				Logger.getLogger(ForgotInternetBankingIdMail.class.getName()).log(Level.SEVERE,null,e);
			}
			return null;
