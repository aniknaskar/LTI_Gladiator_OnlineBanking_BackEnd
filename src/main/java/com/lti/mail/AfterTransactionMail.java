...
public class AfterTransactionMail {
	...
	private static Message prepareMessage(Session session, String myEmail, String recipient, String m)
	{
		...
		Message message =new MimeMessage(session);
			...
			try {
				...
				message.setSubject("Transaction Notification From Digi Seva");
				message.setText(m);
				return message;
			} 
			catch (Exception e) {
				
				Logger.getLogger(AfterTransactionMail.class.getName()).log(Level.SEVERE,null,e);
			}
			return null;
