...
public class AfterSuccessfulVerificationMail {
	...
	private static Message prepareMessage(Session session, String myEmail, String recipient, String m)
	{
		...
		Message message =new MimeMessage(session);
			...
			try {
				...
				message.setSubject("Welcome to Digi Seva");
				message.setText(m);
				return message;
			} 
			catch (Exception e) {
				
				Logger.getLogger(AfterSuccessfulVerificationMail.class.getName()).log(Level.SEVERE,null,e);
			}
			return null;
