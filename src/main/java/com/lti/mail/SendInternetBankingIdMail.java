...
public class SendInternetBankingIdMail {
	...
	private static Message prepareMessage(Session session, String myEmail, String recipient, String m)
	{
		...
		Message message =new MimeMessage(session);
			...
			try {
				...
				message.setSubject("InternetBanking ID Retrieval");
				message.setText(m);
				return message;
			} 
			catch (Exception e) {
				
				Logger.getLogger(SendInternetBankingIdMail.class.getName()).log(Level.SEVERE,null,e);
			}
			return null;
