...
public class LoginAccountActivationThroughOTPMail {
	...
	private static Message prepareMessage(Session session, String myEmail, String recipient, String m)
	{
		...
		Message message =new MimeMessage(session);
			...
			try {
				...
				message.setSubject("OTP For Digi Seva account activation ");
				message.setText(m);
				return message;
			} 
			catch (Exception e) {
				
				Logger.getLogger(LoginAccountActivationThroughOTPMail.class.getName()).log(Level.SEVERE,null,e);
			}
			return null;
